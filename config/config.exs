...
config :polly,
  ...
  ash_domains: [Polly.Accounts, Polly.Audit, Polly.Members, Polly.Polls]
...
config :polly, PollyWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: PollyWeb.ErrorHTML, json: PollyWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Polly.PubSub,
  live_view: [signing_salt: "sZ7fdOTR"]
